    ...
    public static void main(String[] args) {
       ...
       ServiceUniversite sp = new ServiceUniversite();
        ...
        try {
          ...
          //  sp.ajouter(new Universite( "ensi", "jolie", "mannouba", "image20.jpg", 8250));
           //System.out.println("université ajouté");
         //   sp.modifier(new Universite( 62,"enstabsss", "jolie", "borjcedria", "image5.jpg", 7500));
          //  sp.modifier(new Universite( 63,"ensi", "jolie", "mannouba", "image25.jpg", 8250));
